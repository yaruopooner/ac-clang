...
# export CC=clang
# export CXX=clang++
# declare TARGET_LLVM_VERSION="${1-llvmorg-9.0.0}"
...
if [ ${1} ]; then
    TARGET_LLVM_VERSION="${1}"
fi


declare -r LLVM_LIBRARY_PATH="${LLVM_BUILD_SHELLS_PATH}/sh/build/${TARGET_LLVM_VERSION}/${TARGET_CONFIG}"
