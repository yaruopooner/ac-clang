...
# last updated : 2014/11/19.15:43:22
...
* libclang について
  ...
  clang-serverをセルフビルドする場合は libclang-x86_64.lib を
  ac-clang/clang-server/library/x86_64/release
  の下にコピーしてください。
  ※clang-server.zipをac-clangに解凍すると自動的に上記パス上に解凍されます。
...
* オフィシャルのlibclangを使用する場合の制限事項
  ...
  リリースバイナリのlibclang-x86_XX.dllを使用している場合は発生しない。
